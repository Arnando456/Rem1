...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const AzizAE = ["6281534162316@s.whatsapp.net"]
			...
			const ownerNumber = [
			"6281534162316@s.whatsapp.net"
			]
			premium = [
			"6281534162316@s.whatsapp.net","6285336444866@s.whatsapp.net","6285158266626@s.whatsapp.net","6281227825649@s.whatsapp.net","6282325959215@s.whatsapp.net","6281225084189@s.whatsapp.net"
			]
...
break
		...
		case 'daftar':
					...
					if (isBanned) return reply(mess.only.benned)
					if (args.length < 1) return reply(`Parameter Salah\nCommand : ${prefix}daftar nama/umur\nContoh : ${prefix}daftar Arnando/15/Medan`)
					reg = `${body.slice(8)}`
					jeneng = reg.split("/")[0];
					umure = reg.split("/")[1];
					asal = reg.split("/")[2];
         ...
         case 'lirik':
                ...
                if (!isUser) return reply(mess.only.userB)
                    ...
                    client.sendMessage('6281534162316@s.whatsapp.net', options, text, {quoted: mek})
		    ...
		    case 'map':
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `[ *BOT REM BROADCAST* ]\n\n${body.slice(4)}`)
						}
						reply('Suksess broadcast')
					}
					break
